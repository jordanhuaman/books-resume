...
import jordan.java.domain.policy.RegexEventParser;
import jordan.java.domain.policy.SplitEventParser;
import jordan.java.domain.vo.Activity;
import jordan.java.domain.vo.EventId;
import jordan.java.domain.vo.ParsePolicyType;
import jordan.java.domain.vo.Protocol;
